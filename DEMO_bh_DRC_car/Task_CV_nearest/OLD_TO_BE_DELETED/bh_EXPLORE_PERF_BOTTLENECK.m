function bh_EXPLORE_PERF_BOTTLENECK()
...
function LOC_do_mex_build(IMG_SIZE)
    ...
    % Define argument types for entry-point 'bh_my_ALGORITHM_for_codegen'.
    ARGS = cell(1,1);
    ARGS{1} = cell(3,1);
    ...
    % Invoke MATLAB Coder.
    codegen -config cfg bh_my_ALGORITHM_for_codegen -args ARGS{1} -nargout 3
end
