...
static emlrtRSInfo dg_emlrtRSI = { 35, /* lineNo */
...
static emlrtRSInfo eg_emlrtRSI = { 38, /* lineNo */
  "bh_line_homog_CLS",                 /* fcnName */
  "C:\\bh\\users_EV\\sandpit\\bh_car_models\\devel\\THE_LIBRARY\\my_cv_classes\\bh_line_homog_CLS.m"/* pathName */
};

static emlrtRSInfo fg_emlrtRSI = { 61, /* lineNo */
  "bh_line_homog_CLS",                 /* fcnName */
  "C:\\bh\\users_EV\\sandpit\\bh_car_models\\devel\\THE_LIBRARY\\my_cv_classes\\bh_line_homog_CLS.m"/* pathName */
};

static emlrtRSInfo gg_emlrtRSI = { 68, /* lineNo */
...
static emlrtRSInfo ig_emlrtRSI = { 86, /* lineNo */
  "xgemm",                             /* fcnName */
  "C:\\MATLAB\\R2017b\\toolbox\\eml\\eml\\+coder\\+internal\\+blas\\xgemm.m"/* pathName */
};

static emlrtRSInfo jg_emlrtRSI = { 87, /* lineNo */
  "xgemm",                             /* fcnName */
  "C:\\MATLAB\\R2017b\\toolbox\\eml\\eml\\+coder\\+internal\\+blas\\xgemm.m"/* pathName */
};
...
static emlrtRTEInfo cg_emlrtRTEI = { 104,/* lineNo */
  23,                                  /* colNo */
...
void bh_line_homog_CLS_get_mc(real_T OBJ_a, real_T OBJ_b, real_T OBJ_d, const
  char_T OBJ_line_type_data[], const int32_T OBJ_line_type_size[2], real_T
  mc_col[2])
{
  boolean_T tf_val;
  int32_T i;
  int32_T exitg1;
  static const char_T cv5[6] = { 'S', 'L', 'O', 'P', 'E', 'Y' };
  ...
  OBJ_line_type_data[], int32_T OBJ_line_type_size[2])
{
  ...
  static const char_T cv1[4] = { 'V', 'E', 'R', 'T' };

  static const char_T cv2[4] = { 'H', 'O', 'R', 'Z' };
  ...
  if (!(a->size[1] == A->size[0])) {
    emlrtErrorWithMessageIdR2012b(&b_st, &cg_emlrtRTEI, "Coder:MATLAB:innerdim",
      0);
  }
  ...
  if (OBJ_line_type_size[1] == 6) {
    ...
    do {
      exitg2 = 0;
      if (ixstart + 1 < 7) {
        if (OBJ_line_type_data[ixstart] != cv0[ixstart]) {
          exitg2 = 1;
        } else {
          ixstart++;
        }
  ...
  uv_bot[2], real_T uv_top[2])
{
  ...
  boolean_T b_bool;
  int32_T exitg1;
  static const char_T cv3[4] = { 'V', 'E', 'R', 'T' };

  real_T u;
  real_T v;
  static const char_T cv4[4] = { 'H', 'O', 'R', 'Z' };
