...
static emlrtRSInfo l_emlrtRSI = { 266, /* lineNo */
  "rgb2lab",                           /* fcnName */
  "C:\\MATLAB\\R2017b\\toolbox\\images\\colorspaces\\eml\\rgb2lab.m"/* pathName */
};
...
static emlrtRSInfo fb_emlrtRSI = { 80, /* lineNo */
  "power",                             /* fcnName */
  "C:\\MATLAB\\R2017b\\toolbox\\eml\\lib\\matlab\\ops\\power.m"/* pathName */
};
...
static emlrtRSInfo kb_emlrtRSI = { 210,/* lineNo */
  "minOrMax",                          /* fcnName */
  "C:\\MATLAB\\R2017b\\toolbox\\eml\\eml\\+coder\\+internal\\minOrMax.m"/* pathName */
};

static emlrtRSInfo lb_emlrtRSI = { 213,/* lineNo */
  "minOrMax",                          /* fcnName */
  "C:\\MATLAB\\R2017b\\toolbox\\eml\\eml\\+coder\\+internal\\minOrMax.m"/* pathName */
};

static emlrtRSInfo mb_emlrtRSI = { 214,/* lineNo */
  "minOrMax",                          /* fcnName */
  "C:\\MATLAB\\R2017b\\toolbox\\eml\\eml\\+coder\\+internal\\minOrMax.m"/* pathName */
};

static emlrtRSInfo nb_emlrtRSI = { 376,/* lineNo */
  "minOrMax",                          /* fcnName */
  "C:\\MATLAB\\R2017b\\toolbox\\eml\\eml\\+coder\\+internal\\minOrMax.m"/* pathName */
};
...
static emlrtRSInfo bc_emlrtRSI = { 228,/* lineNo */
  "ybp_finder_CLS",                    /* fcnName */
  "C:\\bh\\users_EV\\sandpit\\bh_car_models\\devel\\THE_LIBRARY\\my_cv_classes\\ybp_finder_CLS.m"/* pathName */
};

static emlrtRSInfo cc_emlrtRSI = { 242,/* lineNo */
  "ybp_finder_CLS",                    /* fcnName */
  "C:\\bh\\users_EV\\sandpit\\bh_car_models\\devel\\THE_LIBRARY\\my_cv_classes\\ybp_finder_CLS.m"/* pathName */
};

static emlrtRSInfo dc_emlrtRSI = { 264,/* lineNo */
  "ybp_finder_CLS",                    /* fcnName */
  "C:\\bh\\users_EV\\sandpit\\bh_car_models\\devel\\THE_LIBRARY\\my_cv_classes\\ybp_finder_CLS.m"/* pathName */
};

static emlrtRSInfo pf_emlrtRSI = { 234,/* lineNo */
  "find",                              /* fcnName */
...
static emlrtRTEInfo fe_emlrtRTEI = { 73,/* lineNo */
  21,                                  /* colNo */
  "ybp_finder_CLS",                    /* fName */
  "C:\\bh\\users_EV\\sandpit\\bh_car_models\\devel\\THE_LIBRARY\\my_cv_classes\\ybp_finder_CLS.m"/* pName */
};

static emlrtRTEInfo ge_emlrtRTEI = { 74,/* lineNo */
  5,                                   /* colNo */
  "ybp_finder_CLS",                    /* fName */
  "C:\\bh\\users_EV\\sandpit\\bh_car_models\\devel\\THE_LIBRARY\\my_cv_classes\\ybp_finder_CLS.m"/* pName */
};

static emlrtRTEInfo he_emlrtRTEI = { 75,/* lineNo */
  5,                                   /* colNo */
  "ybp_finder_CLS",                    /* fName */
  "C:\\bh\\users_EV\\sandpit\\bh_car_models\\devel\\THE_LIBRARY\\my_cv_classes\\ybp_finder_CLS.m"/* pName */
};

static emlrtRTEInfo ie_emlrtRTEI = { 76,/* lineNo */
  5,                                   /* colNo */
  "ybp_finder_CLS",                    /* fName */
  "C:\\bh\\users_EV\\sandpit\\bh_car_models\\devel\\THE_LIBRARY\\my_cv_classes\\ybp_finder_CLS.m"/* pName */
};

static emlrtRTEInfo je_emlrtRTEI = { 79,/* lineNo */
  32,                                  /* colNo */
  "ybp_finder_CLS",                    /* fName */
  "C:\\bh\\users_EV\\sandpit\\bh_car_models\\devel\\THE_LIBRARY\\my_cv_classes\\ybp_finder_CLS.m"/* pName */
};

static emlrtRTEInfo ke_emlrtRTEI = { 132,/* lineNo */
  1,                                   /* colNo */
  "minOrMax",                          /* fName */
...
static emlrtRTEInfo ne_emlrtRTEI = { 79,/* lineNo */
  31,                                  /* colNo */
  "ybp_finder_CLS",                    /* fName */
  "C:\\bh\\users_EV\\sandpit\\bh_car_models\\devel\\THE_LIBRARY\\my_cv_classes\\ybp_finder_CLS.m"/* pName */
};

static emlrtRTEInfo oe_emlrtRTEI = { 99,/* lineNo */
  5,                                   /* colNo */
  "ybp_finder_CLS",                    /* fName */
  "C:\\bh\\users_EV\\sandpit\\bh_car_models\\devel\\THE_LIBRARY\\my_cv_classes\\ybp_finder_CLS.m"/* pName */
};

static emlrtRTEInfo pe_emlrtRTEI = { 73,/* lineNo */
  5,                                   /* colNo */
  "ybp_finder_CLS",                    /* fName */
  "C:\\bh\\users_EV\\sandpit\\bh_car_models\\devel\\THE_LIBRARY\\my_cv_classes\\ybp_finder_CLS.m"/* pName */
};
  ...
  *BW, emxArray_boolean_T *new_BW, boolean_T *tf_found_it)
{
  ...
  if (stats->size[0] != 0) {
    ...
    if ((b_x[0] != iv5[0]) || (b_x[1] != iv5[1])) {
      emlrtSizeEqCheckNDR2012b(&b_x[0], &iv5[0], &emlrtECI, sp);
    }
    ...
    if ((iv5[0] != b_x[0]) || (iv5[1] != b_x[1])) {
      emlrtSizeEqCheckNDR2012b(&iv5[0], &b_x[0], &d_emlrtECI, sp);
    }
    ...
    if ((iv5[0] != b_x[0]) || (iv5[1] != b_x[1])) {
      emlrtSizeEqCheckNDR2012b(&iv5[0], &b_x[0], &c_emlrtECI, sp);
    }
    ...
    if ((iv5[0] != b_x[0]) || (iv5[1] != b_x[1])) {
      emlrtSizeEqCheckNDR2012b(&iv5[0], &b_x[0], &b_emlrtECI, sp);
    }
  ...
  uint8_T DRC_image[230400])
{
  ...
  h_st.tls = g_st.tls;
  emlrtHeapReferenceStackEnterFcnR2012b(sp);
  emxInit_uint8_T(sp, &rgb, 3, &ee_emlrtRTEI, true);
  overflow = false;
  st.site = &g_emlrtRSI;
  ...
  rgb->size[1] = 320;
  rgb->size[2] = 3;
  emxEnsureCapacity_uint8_T(&st, rgb, ixstart, &ee_emlrtRTEI);
  ...
  emxInit_real_T2(&st, &lab_DRC_image, 3, &pe_emlrtRTEI, true);
  ...
  emxEnsureCapacity_real_T2(&st, lab_DRC_image, ixstart, &fe_emlrtRTEI);
  for (nx = 0; nx < 320; nx++) {
    for (k = 0; k < 145; k++) {
  ...
  emxFree_uint8_T(&rgb);
  emxInit_real_T(&st, &a, 2, &ge_emlrtRTEI, true);
  ixstart = a->size[0] * a->size[1];
  a->size[0] = 145;
  a->size[1] = 320;
  emxEnsureCapacity_real_T(sp, a, ixstart, &ge_emlrtRTEI);
  ...
  emxInit_real_T(sp, &b, 2, &he_emlrtRTEI, true);
  ixstart = b->size[0] * b->size[1];
  b->size[0] = 145;
  b->size[1] = 320;
  emxEnsureCapacity_real_T(sp, b, ixstart, &he_emlrtRTEI);
  for (ixstart = 0; ixstart < 320; ixstart++) {
    for (ixstop = 0; ixstop < 145; ixstop++) {
  ...
  emxInit_real_T2(sp, &distance, 3, &ie_emlrtRTEI, true);
  fz = OBJ->nColors;
  if (!(fz >= 0.0)) {
  ...
  emxEnsureCapacity_real_T2(sp, distance, ixstart, &ie_emlrtRTEI);
  k = 46400 * (int32_T)fz;
  ...
  emlrtForLoopVectorCheckR2012b(1.0, 1.0, OBJ->nColors, mxDOUBLE_CLASS, (int32_T)
    OBJ->nColors, &hg_emlrtRTEI, sp);
  cindx = 0;
  emxInit_real_T(sp, &indx, 2, &t_emlrtRTEI, true);
  emxInit_real_T(sp, &b_a, 2, &ne_emlrtRTEI, true);
  emxInit_real_T(sp, &b_b, 2, &le_emlrtRTEI, true);
  ...
  while (cindx <= (int32_T)OBJ->nColors - 1) {
    ...
    indx->size[1] = 320;
    emxEnsureCapacity_real_T(sp, indx, ixstart, &je_emlrtRTEI);
    ...
    b_b->size[0] = b->size[0];
    b_b->size[1] = 320;
    emxEnsureCapacity_real_T(sp, b_b, ixstart, &le_emlrtRTEI);
    ...
    b_a->size[1] = 320;
    emxEnsureCapacity_real_T(&st, b_a, ixstart, &ne_emlrtRTEI);
    d_a = b_a->size[0];
    nx = b_a->size[1];
    k = d_a * nx;
    for (ixstart = 0; ixstart < k; ixstart++) {
    ...
    if (!dimagree(indx, b_a)) {
      emlrtErrorWithMessageIdR2012b(&d_st, &sf_emlrtRTEI, "MATLAB:dimagree", 0);
    }
    ...
    emlrtSubAssignSizeCheckR2012b(&iv24[0], 2, &(*(int32_T (*)[2])indx->size)[0],
      2, &f_emlrtECI, sp);
    for (ixstart = 0; ixstart < 320; ixstart++) {
      k = indx->size[0];
  ...
  iindx->size[0] = 145;
  iindx->size[1] = 320;
  emxEnsureCapacity_int32_T1(&c_st, iindx, ixstart, &ke_emlrtRTEI);
  ...
  for (nx = 1; nx <= vstride; nx++) {
    ...
    if (n > 1) {
      ...
      if (muDoubleScalarIsNaN(distance->data[nx - 1])) {
        ...
        if (vstride == 0) {
          emlrtErrorWithMessageIdR2012b(&e_st, &gg_emlrtRTEI,
  ...
  indx->size[1] = 320;
  emxEnsureCapacity_real_T(&b_st, indx, ixstart, &me_emlrtRTEI);
  ...
  emxEnsureCapacity_real_T(sp, OBJ->label, ixstart, &oe_emlrtRTEI);
  for (ixstart = 0; ixstart < 320; ixstart++) {
