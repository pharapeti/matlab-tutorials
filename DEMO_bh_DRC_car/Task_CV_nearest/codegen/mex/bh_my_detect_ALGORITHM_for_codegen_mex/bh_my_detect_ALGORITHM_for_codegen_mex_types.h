/*
 * bh_my_detect_ALGORITHM_for_codegen_mex_types.h
 *
 * Code generation for function 'bh_my_detect_ALGORITHM_for_codegen'
 *
 */

#ifndef BH_MY_DETECT_ALGORITHM_FOR_CODEGEN_MEX_TYPES_H
#define BH_MY_DETECT_ALGORITHM_FOR_CODEGEN_MEX_TYPES_H
...
#ifndef typedef_g_bh_my_detect_ALGORITHM_for_co
#define typedef_g_bh_my_detect_ALGORITHM_for_co

typedef struct {
  union
  {
    struct {
      lane_info_CLS_1 BLUE_O;
      lane_info_CLS_1 YELL_O;
    } f0;
...
} g_bh_my_detect_ALGORITHM_for_co;

#endif                                 /*typedef_g_bh_my_detect_ALGORITHM_for_co*/
...
/* End of code generation (bh_my_detect_ALGORITHM_for_codegen_mex_types.h) */
