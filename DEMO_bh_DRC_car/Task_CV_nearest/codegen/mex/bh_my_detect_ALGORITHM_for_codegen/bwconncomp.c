...
static emlrtRSInfo nc_emlrtRSI = { 43, /* lineNo */
  "bwconncomp",                        /* fcnName */
  "C:\\MATLAB\\R2017b\\toolbox\\images\\images\\eml\\bwconncomp.m"/* pathName */
};

static emlrtRSInfo oc_emlrtRSI = { 55, /* lineNo */
  "bwconncomp",                        /* fcnName */
  "C:\\MATLAB\\R2017b\\toolbox\\images\\images\\eml\\bwconncomp.m"/* pathName */
};

static emlrtRSInfo pc_emlrtRSI = { 56, /* lineNo */
  "bwconncomp",                        /* fcnName */
  "C:\\MATLAB\\R2017b\\toolbox\\images\\images\\eml\\bwconncomp.m"/* pathName */
};

static emlrtRSInfo qc_emlrtRSI = { 57, /* lineNo */
  "bwconncomp",                        /* fcnName */
  "C:\\MATLAB\\R2017b\\toolbox\\images\\images\\eml\\bwconncomp.m"/* pathName */
};

static emlrtRSInfo rc_emlrtRSI = { 65, /* lineNo */
  "bwconncomp",                        /* fcnName */
  "C:\\MATLAB\\R2017b\\toolbox\\images\\images\\eml\\bwconncomp.m"/* pathName */
};

static emlrtRSInfo sc_emlrtRSI = { 33, /* lineNo */
  "intermediateLabelRuns",             /* fcnName */
  "C:\\MATLAB\\R2017b\\toolbox\\images\\images\\+images\\+internal\\+coder\\intermediateLabelRuns.m"/* pathName */
};

static emlrtRSInfo tc_emlrtRSI = { 51, /* lineNo */
  "intermediateLabelRuns",             /* fcnName */
  "C:\\MATLAB\\R2017b\\toolbox\\images\\images\\+images\\+internal\\+coder\\intermediateLabelRuns.m"/* pathName */
};

static emlrtRSInfo uc_emlrtRSI = { 114,/* lineNo */
  "intermediateLabelRuns",             /* fcnName */
  "C:\\MATLAB\\R2017b\\toolbox\\images\\images\\+images\\+internal\\+coder\\intermediateLabelRuns.m"/* pathName */
};

static emlrtRSInfo vc_emlrtRSI = { 149,/* lineNo */
  "intermediateLabelRuns",             /* fcnName */
  "C:\\MATLAB\\R2017b\\toolbox\\images\\images\\+images\\+internal\\+coder\\intermediateLabelRuns.m"/* pathName */
};

static emlrtRSInfo wc_emlrtRSI = { 150,/* lineNo */
  "intermediateLabelRuns",             /* fcnName */
  "C:\\MATLAB\\R2017b\\toolbox\\images\\images\\+images\\+internal\\+coder\\intermediateLabelRuns.m"/* pathName */
};

static emlrtRSInfo xc_emlrtRSI = { 153,/* lineNo */
  "intermediateLabelRuns",             /* fcnName */
  "C:\\MATLAB\\R2017b\\toolbox\\images\\images\\+images\\+internal\\+coder\\intermediateLabelRuns.m"/* pathName */
};
...
static emlrtRTEInfo bb_emlrtRTEI = { 41,/* lineNo */
  1,                                   /* colNo */
  "bwconncomp",                        /* fName */
  "C:\\MATLAB\\R2017b\\toolbox\\images\\images\\eml\\bwconncomp.m"/* pName */
};
                ...
                emxArray_int32_T *CC_RegionLengths)
{
  ...
  emxInit_int32_T(&st, &regionLengths, 1, &bb_emlrtRTEI, true);
  emxInit_int32_T(&st, &startRow, 1, &x_emlrtRTEI, true);
  emxInit_int32_T(&st, &endRow, 1, &x_emlrtRTEI, true);
  emxInit_int32_T(&st, &startCol, 1, &x_emlrtRTEI, true);
  if (numRuns == 0) {
    i4 = startRow->size[0];
    startRow->size[0] = 0;
    emxEnsureCapacity_int32_T(&st, startRow, i4, &x_emlrtRTEI);
    i4 = endRow->size[0];
    endRow->size[0] = 0;
    emxEnsureCapacity_int32_T(&st, endRow, i4, &x_emlrtRTEI);
    i4 = startCol->size[0];
    startCol->size[0] = 0;
    emxEnsureCapacity_int32_T(&st, startCol, i4, &x_emlrtRTEI);
    i4 = regionLengths->size[0];
    regionLengths->size[0] = 0;
    emxEnsureCapacity_int32_T(&st, regionLengths, i4, &x_emlrtRTEI);
  } else {
    i4 = startRow->size[0];
    if (!(numRuns >= 0)) {
    ...
    emxEnsureCapacity_int32_T(&st, startRow, i4, &y_emlrtRTEI);
    i4 = endRow->size[0];
    endRow->size[0] = numRuns;
    emxEnsureCapacity_int32_T(&st, endRow, i4, &y_emlrtRTEI);
    i4 = startCol->size[0];
    startCol->size[0] = numRuns;
    emxEnsureCapacity_int32_T(&st, startCol, i4, &y_emlrtRTEI);
          ...
          if (endRow->data[k - 1] >= startRow->data[p - 1] - 1) {
            ...
            if (startRow->data[k - 1] <= endRow->data[p - 1] + 1) {
              ...
              if (regionLengths->data[k - 1] == 0) {
                i4 = regionLengths->size[0];
                if (!((p >= 1) && (p <= i4))) {
                  emlrtDynamicBoundsCheckR2012b(p, 1, i4, &cc_emlrtBCI, &st);
                }

                i4 = regionLengths->size[0];
                if (!((k >= 1) && (k <= i4))) {
                  emlrtDynamicBoundsCheckR2012b(k, 1, i4, &dc_emlrtBCI, &st);
                }
  ...
  if (numRuns == 0) {
    ...
    emxEnsureCapacity_real_T1(sp, CC_RegionIndices, i4, &x_emlrtRTEI);
    i4 = CC_RegionLengths->size[0];
    CC_RegionLengths->size[0] = 1;
    emxEnsureCapacity_int32_T(sp, CC_RegionLengths, i4, &x_emlrtRTEI);
    CC_RegionLengths->data[0] = 0;
  } else {
    emxInit_int32_T(sp, &labelsRenumbered, 1, &ab_emlrtRTEI, true);
    i4 = labelsRenumbered->size[0];
    labelsRenumbered->size[0] = regionLengths->size[0];
    emxEnsureCapacity_int32_T(sp, labelsRenumbered, i4, &x_emlrtRTEI);
    numComponents = 0.0;
    st.site = &mc_emlrtRSI;
    for (k = 1; k <= numRuns; k++) {
      i4 = regionLengths->size[0];
      if (!(k <= i4)) {
        emlrtDynamicBoundsCheckR2012b(k, 1, i4, &mc_emlrtBCI, sp);
      }
      ...
      i5 = regionLengths->size[0];
      if (!(k <= i5)) {
        emlrtDynamicBoundsCheckR2012b(k, 1, i5, &pc_emlrtBCI, sp);
      }
      ...
      i4 = labelsRenumbered->size[0];
      if (!(k <= i4)) {
        emlrtDynamicBoundsCheckR2012b(k, 1, i4, &qc_emlrtBCI, sp);
      }
    ...
    emxEnsureCapacity_int32_T(sp, regionLengths, i4, &x_emlrtRTEI);
    if (numComponents != (int32_T)numComponents) {
      emlrtIntegerCheckR2012b(numComponents, &d_emlrtDCI, sp);
    }
    ...
    for (k = 1; k <= numRuns; k++) {
      ...
      if (labelsRenumbered->data[k - 1] > 0) {
        ...
        i4 = endRow->size[0];
        if (!(k <= i4)) {
          emlrtDynamicBoundsCheckR2012b(k, 1, i4, &jc_emlrtBCI, sp);
        }
        ...
        if (!((row >= 1) && (row <= i4))) {
          emlrtDynamicBoundsCheckR2012b(row, 1, i4, &lc_emlrtBCI, sp);
        }
    ...
    emxInit_real_T1(&c_st, &pixelIdxList, 1, &cb_emlrtRTEI, true);
    emxInit_int32_T(&c_st, &x, 1, &x_emlrtRTEI, true);
    if (!(y >= 0.0)) {
    ...
    emxEnsureCapacity_real_T1(sp, pixelIdxList, i4, &x_emlrtRTEI);
    st.site = &pc_emlrtRSI;
    i4 = x->size[0];
    x->size[0] = regionLengths->size[0];
    emxEnsureCapacity_int32_T(&st, x, i4, &x_emlrtRTEI);
    ...
    emxInit_int32_T(&c_st, &idxCount, 1, &db_emlrtRTEI, true);
    i4 = idxCount->size[0];
    idxCount->size[0] = 1 + x->size[0];
    emxEnsureCapacity_int32_T(sp, idxCount, i4, &x_emlrtRTEI);
    idxCount->data[0] = 0;
    row = x->size[0];
    for (i4 = 0; i4 < row; i4++) {
    ...
    for (k = 1; k <= numRuns; k++) {
      ...
      i4 = labelsRenumbered->size[0];
      if (!(k <= i4)) {
        emlrtDynamicBoundsCheckR2012b(k, 1, i4, &ec_emlrtBCI, sp);
      }
      ...
      if (labelsRenumbered->data[k - 1] > 0) {
        ...
        for (firstRunOnPreviousColumn = startRow->data[k - 1];
          ...
          i4 = idxCount->size[0];
          if (!((runCounter >= 1) && (runCounter <= i4))) {
            emlrtDynamicBoundsCheckR2012b(runCounter, 1, i4, &fc_emlrtBCI, sp);
          }
          ...
          i5 = idxCount->size[0];
          if (!((runCounter >= 1) && (runCounter <= i5))) {
            emlrtDynamicBoundsCheckR2012b(runCounter, 1, i5, &hc_emlrtBCI, sp);
          }
