...
static emlrtRTEInfo ob_emlrtRTEI = { 22,/* lineNo */
  16,                                  /* colNo */
  "lane_info_CLS",                     /* fName */
  ...
  *OBJ_tf_is_detected)
{
  ...
  OBJ_BW->size[1] = 320;
  emxEnsureCapacity_boolean_T(sp, OBJ_BW, i, &ob_emlrtRTEI);
  ...
  if (tf_found) {
    emxInit_int32_T(&st, &ii, 1, &t_emlrtRTEI, true);
    emxInit_int32_T(&st, &idx, 1, &pb_emlrtRTEI, true);
    ...
    emxEnsureCapacity_int32_T(&c_st, idx, i, &ob_emlrtRTEI);
    loop_ub = ii->size[0];
    for (i = 0; i < loop_ub; i++) {
    ...
    if (!p) {
      emlrtErrorWithMessageIdR2012b(&c_st, &uc_emlrtRTEI,
    ...
    emxInit_int32_T(&c_st, &vk, 1, &qb_emlrtRTEI, true);
    i = vk->size[0];
    vk->size[0] = idx->size[0];
    emxEnsureCapacity_int32_T(&c_st, vk, i, &ob_emlrtRTEI);
    loop_ub = idx->size[0];
    for (i = 0; i < loop_ub; i++) {
    ...
    emxInit_real_T1(&c_st, &b_vk, 1, &ob_emlrtRTEI, true);
    ...
    emxEnsureCapacity_real_T1(&st, b_vk, i, &ob_emlrtRTEI);
    loop_ub = vk->size[0];
    for (i = 0; i < loop_ub; i++) {
    ...
    emxFree_int32_T(&vk);
    emxInit_real_T1(&st, &b_idx, 1, &ob_emlrtRTEI, true);
    i = b_idx->size[0];
    b_idx->size[0] = idx->size[0];
    emxEnsureCapacity_real_T1(&st, b_idx, i, &ob_emlrtRTEI);
    loop_ub = idx->size[0];
    for (i = 0; i < loop_ub; i++) {
