  ...
  emlrtMsgIdentifier *msgId, real_T ret[5])
{
  ...
  for (i14 = 0; i14 < 5; i14++) {
    ret[i14] = (*(real_T (*)[5])emlrtMxGetData(src))[i14];
  }
  ...
  emlrtMsgIdentifier *msgId, real_T ret[10])
{
  ...
  for (i15 = 0; i15 < 2; i15++) {
    for (i16 = 0; i16 < 5; i16++) {
      ret[i16 + 5 * i15] = (*(real_T (*)[10])emlrtMxGetData(src))[i16 + 5 * i15];
    }
  }
  ...
  mxArray *plhs[3])
{
  ...
  emxInitStruct_struct1_T(&st, &BLUE_s, &wb_emlrtRTEI, true);
  emxInitStruct_struct1_T(&st, &YELL_s, &wb_emlrtRTEI, true);
  emxInitStruct_struct2_T(&st, &PURP_s, &wb_emlrtRTEI, true);
