...
#include "main.h"
#include "bh_MY_CV_ALGORITHMS_terminate.h"
#include "bh_MY_CV_ALGORITHMS_emxAPI.h"
#include "bh_MY_CV_ALGORITHMS_initialize.h"

/* Function Declarations */
static void argInit_1x5_real_T(double result[5]);
static void argInit_240x320_boolean_T(boolean_T result[76800]);
...
static void main_bh_my_lane_preprocess_mask(void);
static void main_bh_my_track_ALGORITHM_for_codegen(void);
...
/*
 * Arguments    : boolean_T result[76800]
 * Return Type  : void
 */
static void argInit_240x320_boolean_T(boolean_T result[76800])
{
  ...
  for (idx0 = 0; idx0 < 240; idx0++) {
    for (idx1 = 0; idx1 < 320; idx1++) {
      /* Set the value of the array element.
         Change this value to the value that the application requires. */
      result[idx0 + 240 * idx1] = argInit_boolean_T();
    }
  }
}
  ...
  for (idx0 = 0; idx0 < 240; idx0++) {
    for (idx1 = 0; idx1 < 320; idx1++) {
      for (idx2 = 0; idx2 < 3; idx2++) {
        /* Set the value of the array element.
           Change this value to the value that the application requires. */
        result[(idx0 + 240 * idx1) + 76800 * idx2] = argInit_uint8_T();
      }
    }
  }
}
...
static void argInit_struct3_T(struct3_T *result)
{
  /* Set the value of each structure field.
     Change this value to the value that the application requires. */
  argInit_240x320_boolean_T(result->BW);
  result->NUM_ROWS = argInit_real_T();
  result->NUM_COLS = argInit_real_T();
  argInit_2x1_real_T(result->tip_upper_xy_col);
  argInit_2x1_real_T(result->tip_lower_xy_col);
  result->m = argInit_real_T();
  result->c = argInit_real_T();
  result->tf_is_detected = argInit_boolean_T();
}
...
static void main_bh_my_detect_ALGORITHM_for_codegen(void)
{
  ...
  bh_my_detect_ALGORITHM_for_codegen(uv0, argInit_boolean_T(), &r2, &BLUE_s,
    &YELL_s, &PURP_s);
...
static void main_bh_my_lane_preprocess_mask(void)
{
  ...
  static struct3_T YELL_out_s;

  /* Initialize function 'bh_my_lane_preprocess_mask' input arguments. */
  /* Initialize function input argument 'BLUE_s'. */
  /* Initialize function input argument 'YELL_s'. */
  /* Call the entry-point 'bh_my_lane_preprocess_mask'. */
  argInit_struct3_T(&r3);
  argInit_struct3_T(&r4);
  bh_my_lane_preprocess_mask(&r3, &r4, argInit_real_T(), &BLUE_out_s,
    &YELL_out_s);
}
...
static void main_bh_my_track_ALGORITHM_for_codegen(void)
{
  ...
  /* Initialize function 'bh_my_track_ALGORITHM_for_codegen' input arguments. */
  /* Initialize function input argument 'BLUE_s'. */
  /* Initialize function input argument 'YELL_s'. */
  /* Call the entry-point 'bh_my_track_ALGORITHM_for_codegen'. */
  argInit_struct3_T(&r5);
  argInit_struct3_T(&r6);
  bh_my_track_ALGORITHM_for_codegen(&r5, &r6, argInit_boolean_T(), BLUE_mc_col,
    YELL_mc_col);
}
...
int main(int argc, const char * const argv[])
{
  ...
  main_bh_my_lane_preprocess_mask();
  main_bh_my_track_ALGORITHM_for_codegen();
