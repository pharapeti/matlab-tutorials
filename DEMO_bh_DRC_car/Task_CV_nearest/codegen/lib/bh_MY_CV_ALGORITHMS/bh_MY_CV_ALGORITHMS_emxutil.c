/*
 * File: bh_MY_CV_ALGORITHMS_emxutil.c
 *
...
static void emxExpand_struct_T1(b_emxArray_struct_T *emxArray, int fromIndex,
  int toIndex);
static void emxExpand_struct_T2(c_emxArray_struct_T *emxArray, int fromIndex,
  int toIndex);
...
/*
 * File trailer for bh_MY_CV_ALGORITHMS_emxutil.c
 *
 * [EOF]
 */
