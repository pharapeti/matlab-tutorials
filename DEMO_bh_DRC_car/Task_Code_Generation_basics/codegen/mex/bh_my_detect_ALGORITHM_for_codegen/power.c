...
static emlrtRTEInfo cd_emlrtRTEI = { 19,/* lineNo */
  24,                                  /* colNo */
...
void b_power(const emlrtStack *sp, const emxArray_real_T *a, emxArray_real_T *y)
{
  ...
  emxInit_real_T1(sp, &z, 1, &t_emlrtRTEI, true);
  emxInit_real_T1(sp, &b_z, 1, &cd_emlrtRTEI, true);
  st.site = &p_emlrtRSI;
  ...
  emxEnsureCapacity_real_T1(&c_st, b_z, k, &cd_emlrtRTEI);
  a_idx_0 = (uint32_T)a->size[0];
  b_a_idx_0 = (uint32_T)a->size[0];
  k = z->size[0];
  z->size[0] = (int32_T)b_a_idx_0;
  emxEnsureCapacity_real_T1(&c_st, z, k, &t_emlrtRTEI);
  if (!b_dimagree(z, a)) {
    emlrtErrorWithMessageIdR2012b(&c_st, &nf_emlrtRTEI, "MATLAB:dimagree", 0);
  }
  ...
  emxEnsureCapacity_real_T1(&b_st, y, k, &u_emlrtRTEI);
...
void power(const emlrtStack *sp, const emxArray_real_T *a, emxArray_real_T *y)
{
  ...
  c_st.tls = b_st.tls;
  emlrtHeapReferenceStackEnterFcnR2012b(sp);
  emxInit_real_T(sp, &z, 2, &t_emlrtRTEI, true);
  st.site = &p_emlrtRSI;
  b_st.site = &v_emlrtRSI;
  c_st.site = &w_emlrtRSI;
  ...
  z->size[1] = 320;
  emxEnsureCapacity_real_T(&c_st, z, nx, &t_emlrtRTEI);
  if (!dimagree(z, a)) {
    emlrtErrorWithMessageIdR2012b(&c_st, &nf_emlrtRTEI, "MATLAB:dimagree", 0);
  }
