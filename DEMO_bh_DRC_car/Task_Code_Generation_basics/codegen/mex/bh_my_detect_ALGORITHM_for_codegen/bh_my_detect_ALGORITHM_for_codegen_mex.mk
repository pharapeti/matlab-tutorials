START_DIR = C:\bh\users_EV\sandpit\BH_CAR~1\devel\TASK_C~1

MATLAB_ROOT = C:\MATLAB\R2017b
MAKEFILE = bh_my_detect_ALGORITHM_for_codegen_mex.mk

include bh_my_detect_ALGORITHM_for_codegen_mex.mki


SRC_FILES =  \
	bh_my_detect_ALGORITHM_for_codegen_mexutil.c \
	bh_my_detect_ALGORITHM_for_codegen_data.c \
	bh_my_detect_ALGORITHM_for_codegen_initialize.c \
	...
	error1.c \
	box_info_CLS.c \
	_coder_bh_my_detect_ALGORITHM_for_codegen_info.c \
...
SYS_INCLUDE += /I "$(START_DIR)\codegen\mex\bh_my_detect_ALGORITHM_for_codegen"
...
%.$(OBJEXT) : $(START_DIR)\codegen\mex\bh_my_detect_ALGORITHM_for_codegen/%.c
	$(CC) $(CFLAGS) "$<"
...
%.$(OBJEXT) : $(START_DIR)\codegen\mex\bh_my_detect_ALGORITHM_for_codegen/%.cpp
	$(CC) $(CPPFLAGS) "$<"
