...
static emlrtRTEInfo ye_emlrtRTEI = { 43,/* lineNo */
  5,                                   /* colNo */
  "sortIdx",                           /* fName */
  "C:\\MATLAB\\R2017b\\toolbox\\eml\\eml\\+coder\\+internal\\sortIdx.m"/* pName */
};

static emlrtRTEInfo af_emlrtRTEI = { 323,/* lineNo */
  1,                                   /* colNo */
  "sortIdx",                           /* fName */
  "C:\\MATLAB\\R2017b\\toolbox\\eml\\eml\\+coder\\+internal\\sortIdx.m"/* pName */
};

static emlrtRTEInfo bf_emlrtRTEI = { 325,/* lineNo */
  1,                                   /* colNo */
  "sortIdx",                           /* fName */
  "C:\\MATLAB\\R2017b\\toolbox\\eml\\eml\\+coder\\+internal\\sortIdx.m"/* pName */
};

static emlrtRTEInfo cf_emlrtRTEI = { 247,/* lineNo */
  14,                                  /* colNo */
  "sortIdx",                           /* fName */
  "C:\\MATLAB\\R2017b\\toolbox\\eml\\eml\\+coder\\+internal\\sortIdx.m"/* pName */
};

static emlrtRTEInfo df_emlrtRTEI = { 247,/* lineNo */
  20,                                  /* colNo */
  "sortIdx",                           /* fName */
  "C:\\MATLAB\\R2017b\\toolbox\\eml\\eml\\+coder\\+internal\\sortIdx.m"/* pName */
};
                   ...
                   *idx)
{
  ...
  idx->size[0] = 1;
  idx->size[1] = x->size[1];
  emxEnsureCapacity_int32_T1(&st, idx, i, &ye_emlrtRTEI);
  ib = x->size[1];
  for (i = 0; i < ib; i++) {
    idx->data[i] = 0;
  }
  ...
  emxInit_int32_T(&c_st, &iwork, 1, &cf_emlrtRTEI, true);
  ib = x->size[1];
  i = iwork->size[0];
  iwork->size[0] = ib;
  emxEnsureCapacity_int32_T(&c_st, iwork, i, &af_emlrtRTEI);
  for (i = 0; i < ib; i++) {
    iwork->data[i] = 0;
  }

  emxInit_real_T1(&c_st, &xwork, 1, &df_emlrtRTEI, true);
  ib = x->size[1];
  i = xwork->size[0];
  xwork->size[0] = ib;
  emxEnsureCapacity_real_T1(&c_st, xwork, i, &bf_emlrtRTEI);
  for (i = 0; i < ib; i++) {
    xwork->data[i] = 0.0;
  }
