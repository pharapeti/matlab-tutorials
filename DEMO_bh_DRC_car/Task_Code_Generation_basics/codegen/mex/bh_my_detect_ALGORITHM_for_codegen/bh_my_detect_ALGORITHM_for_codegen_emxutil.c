/*
 * bh_my_detect_ALGORITHM_for_codegen_emxutil.c
 *
...
static void emxCopyMatrix_real_T(real_T dst[5], const real_T src[5]);
static void emxCopyMatrix_real_T1(real_T dst[10], const real_T src[10]);
static void emxCopyMatrix_real_T2(real_T dst[2], const real_T src[2]);
static void emxCopyMatrix_real_T3(real_T dst[4], const real_T src[4]);
static void emxCopyMatrix_real_T4(real_T dst[16], const real_T src[16]);
...
static void emxExpand_struct_T1(const emlrtStack *sp, b_emxArray_struct_T
  *emxArray, int32_T fromIndex, int32_T toIndex, const emlrtRTEInfo *srcLocation);
static void emxExpand_struct_T2(const emlrtStack *sp, c_emxArray_struct_T
  *emxArray, int32_T fromIndex, int32_T toIndex, const emlrtRTEInfo *srcLocation);
static void emxTrim_struct_T(emxArray_struct_T *emxArray, int32_T fromIndex,
  int32_T toIndex);
static void emxTrim_struct_T1(b_emxArray_struct_T *emxArray, int32_T fromIndex,
  int32_T toIndex);
static void emxTrim_struct_T2(c_emxArray_struct_T *emxArray, int32_T fromIndex,
  int32_T toIndex);
  ...
  *emxArray, int32_T fromIndex, int32_T toIndex, const emlrtRTEInfo *srcLocation)
{
  int32_T i;
  for (i = fromIndex; i < toIndex; i++) {
    emxInitStruct_struct_T1(sp, &emxArray->data[i], srcLocation, false);
  }
}
  ...
  *emxArray, int32_T fromIndex, int32_T toIndex, const emlrtRTEInfo *srcLocation)
{
  int32_T i;
  for (i = fromIndex; i < toIndex; i++) {
    emxInitStruct_struct_T2(sp, &emxArray->data[i], srcLocation, false);
  }
}
  ...
  b_struct_T *src, const emlrtRTEInfo *srcLocation)
{
  ...
  emxCopy_real_T1(sp, &dst->PixelIdxList, &src->PixelIdxList, srcLocation);
}
...
void emxCopyStruct_struct_T2(const emlrtStack *sp, d_struct_T *dst, const
  d_struct_T *src, const emlrtRTEInfo *srcLocation)
{
  dst->Area = src->Area;
  emxCopyMatrix_real_T2(dst->Centroid, src->Centroid);
  emxCopyMatrix_real_T3(dst->BoundingBox, src->BoundingBox);
  ...
  emxCopyMatrix_real_T4(dst->Extrema, src->Extrema);
  ...
  emxCopy_real_T1(sp, &dst->PixelValues, &src->PixelValues, srcLocation);
  emxCopyMatrix_real_T2(dst->WeightedCentroid, src->WeightedCentroid);
  ...
  emxCopyMatrix_real_T2(dst->SubarrayIdxLengths, src->SubarrayIdxLengths);
}

void emxCopyStruct_ybp_finder_CLS(const emlrtStack *sp, ybp_finder_CLS *dst,
  const ybp_finder_CLS *src, const emlrtRTEInfo *srcLocation)
{
  dst->E_tgt_for_lane = src->E_tgt_for_lane;
  dst->A_tgt_for_lane = src->A_tgt_for_lane;
  dst->fraction_of_img_to_ignore = src->fraction_of_img_to_ignore;
  dst->nColors = src->nColors;
  emxCopyMatrix_real_T(dst->color_labels, src->color_labels);
  emxCopyMatrix_real_T1(dst->color_markers, src->color_markers);
  emxCopy_real_T(sp, &dst->label, &src->label, srcLocation);
}
  ...
  *emxArray, int32_T oldNumel, const emlrtRTEInfo *srcLocation)
{
  ...
  if (oldNumel > newNumel) {
    ...
    if (oldNumel < newNumel) {
      emxExpand_struct_T1(sp, emxArray, oldNumel, newNumel, srcLocation);
    }
  }
}

void emxEnsureCapacity_struct_T2(const emlrtStack *sp, c_emxArray_struct_T
  *emxArray, int32_T oldNumel, const emlrtRTEInfo *srcLocation)
{
  int32_T newNumel;
  int32_T i;
  ...
  if (oldNumel > newNumel) {
    ...
    if (oldNumel < newNumel) {
      emxExpand_struct_T2(sp, emxArray, oldNumel, newNumel, srcLocation);
    }
  }
}
...
void emxInitStruct_box_info_CLS(const emlrtStack *sp, box_info_CLS *pStruct,
  const emlrtRTEInfo *srcLocation, boolean_T doPush)
{
  emxInit_boolean_T(sp, &pStruct->BW, 2, srcLocation, doPush);
}
...
void emxInitStruct_struct_T2(const emlrtStack *sp, d_struct_T *pStruct, const
  emlrtRTEInfo *srcLocation, boolean_T doPush)
{
...
void emxInitStruct_ybp_finder_CLS(const emlrtStack *sp, ybp_finder_CLS *pStruct,
  const emlrtRTEInfo *srcLocation, boolean_T doPush)
{
  emxInit_real_T(sp, &pStruct->label, 2, srcLocation, doPush);
}
  ...
  int32_T numDimensions, const emlrtRTEInfo *srcLocation, boolean_T doPush)
{
  ...
  int32_T i;
  *pEmxArray = (c_emxArray_struct_T *)emlrtMallocMex(sizeof(c_emxArray_struct_T));
  if ((void *)*pEmxArray == NULL) {
    emlrtHeapAllocationErrorR2012b(srcLocation, sp);
  }
...
/* End of code generation (bh_my_detect_ALGORITHM_for_codegen_emxutil.c) */
