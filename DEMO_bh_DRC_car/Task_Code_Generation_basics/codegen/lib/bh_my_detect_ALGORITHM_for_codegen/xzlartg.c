...
/*
 * Arguments    : const creal_T b_f
 *                const creal_T g
 *                double *cs
 *                creal_T *sn
 * Return Type  : void
 */
void b_xzlartg(const creal_T b_f, const creal_T g, double *cs, creal_T *sn)
{
  double scale;
  double f2s;
  double x;
    ...
    if (scale <= x * 2.0041683600089728E-292) {
      if ((b_f.re == 0.0) && (b_f.im == 0.0)) {
        ...
        *cs = rt_hypotd_snf(fs_re, fs_im) / g2s;
        ...
        if (x > 1.0) {
          g2 = rt_hypotd_snf(b_f.re, b_f.im);
          fs_re = b_f.re / g2;
          fs_im = b_f.im / g2;
        } else {
 ...
 * Return Type  : void
 */
void xzlartg(const creal_T b_f, const creal_T g, double *cs, creal_T *sn,
             creal_T *r)
{
  double scale;
  double f2s;
