...
properties (SetAccess = private)
    ...
    b
    d
    line_type %char {mustBeMember(line_type,{'HORZ','VERT','SLOPEY','UNKNOWN'})} = 'UNKNOWN';
end
...
function tf_val = isVert(OBJ)
         tf_val = strcmp(OBJ.line_type,'VERT'); 
end
%==========================================================================
function tf_val = isHorz(OBJ)
         tf_val = strcmp(OBJ.line_type,'HORZ'); 
end
%==========================================================================
function tf_val = isSlopey(OBJ)
         tf_val = strcmp(OBJ.line_type,'SLOPEY'); 
end
%==========================================================================
...
function mc_col = get_mc(OBJ)
         ...
         if( true==OBJ.isSlopey()  )
             % a.U + b.V + d = 0
             
             %  b.V = -a.U + -d
             mc_col(1) = (-1*OBJ.a) / OBJ.b;  % m
             mc_col(2) = (-1*OBJ.d) / OBJ.b;  % c
         else
              mc_col = [NaN;  NaN];
         end
end
